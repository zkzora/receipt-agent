...
/** Service tier — mirrors ScanMode in the backend (src/schema/output.ts). */
export type ScanMode = 'full' | 'degen' | 'lp';
...
export interface OffchainSnapshot {
  ...
  /** One-sentence "what this project claims to be", read from its own pages. */
